...
async function main() {
  ...
  await prisma.podcast.deleteMany({
    where: {
      id: { in: [
        'cmmzplu400002bpwitckto7ig',
        'cmmzplu4m000dbpwin0c5ldrc',
      ]},
    },
  });
