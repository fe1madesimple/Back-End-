const b = [
  {
    ...
    legal_principle:
      'Prior to Donoghue v Stevenson, the Court of Appeal held that a duty of care in negligence arose only where there was a direct relationship of proximity equivalent to privity of contract between the parties. A surveyor who negligently certified the progress of building works owed no duty of care to mortgagees who relied on the certificates, as there was no contract between them. This restrictive approach was later overruled by Donoghue v Stevenson [1932].',
    key_quote:
      'A man is no doubt liable for damage caused by his own negligence to those with whom he is in a relationship of proximity equivalent to contract; but apart from such a relationship no duty to take care generally exists.',
    full_summary:
      'Le Lievre v Gold [1893] 1 QB 491 is a pre-Donoghue authority illustrating the restrictive approach to the duty of care that prevailed in English common law before 1932. A surveyor certified stages of building work as complete; mortgagees advanced money in reliance on those certificates, which were negligently issued. When the builder defaulted, the mortgagees sued the surveyor in negligence. The Court of Appeal, following the strict privity-based reasoning of Winterbottom v Wright (1842), held that the surveyor owed no duty of care to the mortgagees. There was no contract between them and no relationship equivalent to privity. Lord Esher MR held that a duty of care in negligence required a relationship akin to privity of contract. This decision is studied in FE-1 torts courses principally as a foil to Donoghue v Stevenson [1932], which established that the duty of care is not confined to contractual relationships, and to Hedley Byrne v Heller [1964], which extended duties of care to negligent misstatement. It demonstrates the historical evolution from the privity-based duty to the neighbour principle.',
    subjects: ['torts'],
    topics: ['negligence', 'duty of care', 'privity', 'historical development', 'pre-Donoghue'],
    is_frequently_tested: true,
    past_paper_appearances: ['Torts FE-1 2015 Q1', 'Torts FE-1 2018 Q1'],
  },
  {
    ...
    jurisdiction: 'England',
    legal_principle:
      "Lord Wilberforce's two-stage test for the duty of care holds that: first, there must be sufficient proximity between the defendant and the claimant such that carelessness by the defendant would be likely to cause damage to the claimant; and second, if the first stage is satisfied, the court considers whether there are any policy reasons that ought to negative or limit the scope of the duty, the class of persons who can rely on it, or the damages which can flow from it. This test was subsequently overruled in Murphy v Brentwood DC [1991].",
    key_quote:
      'Through the two-stage test: first one has to ask whether there is a sufficiently close relationship of proximity; second, whether there are any considerations which ought to negative, reduce or limit the scope of the duty.',
    full_summary:
    ...
    is_frequently_tested: true,
    past_paper_appearances: ['Torts FE-1 2015 Q2', 'Torts FE-1 2017 Q2', 'Torts FE-1 2020 Q1'],
  },
  {
  ...
  },
  {
    ...
    is_frequently_tested: true,
    past_paper_appearances: ['Torts FE-1 2016 Q1', 'Torts FE-1 2019 Q2'],
  },
  {
    ...
    is_frequently_tested: true,
    past_paper_appearances: ['Torts FE-1 2018 Q2'],
  },
  {
    ...
    is_frequently_tested: true,
    past_paper_appearances: ['Torts FE-1 2016 Q2', 'Torts FE-1 2019 Q3', 'Torts FE-1 2022 Q1'],
  },
  {
  ...
  },
  {
    ...
    is_frequently_tested: true,
    past_paper_appearances: ['Torts FE-1 2017 Q2', 'Torts FE-1 2021 Q2'],
  },
  {
  ...
  },
  {
    ...
    jurisdiction: 'Ireland',
    legal_principle:
      'The Irish Supreme Court established a three-part test for the duty of care in negligence: (i) reasonable foreseeability of damage; (ii) proximity of relationship; and (iii) that it is just and reasonable in all the circumstances to impose a duty. The third limb is a distinct requirement that encapsulates policy considerations and is not merely a restatement of foreseeability or proximity.',
    key_quote:
      'There exists a third ingredient of the duty of care beyond foreseeability and proximity, namely that in all the circumstances it is just and reasonable that the law should impose a duty of a given scope upon the defendant for the benefit of the plaintiff.',
    full_summary:
      'Glencar Explorations plc v Mayo County Council [2002] 1 IR 84 is the leading Irish Supreme Court authority on the duty of care in negligence. Glencar held exploration licences and suffered pure economic loss when Mayo County Council adopted an ultra vires moratorium on mining. The plaintiffs claimed the council owed a duty of care in negligence. The Supreme Court, per Keane CJ, rejected the claim and articulated the Irish three-part test for duty of care: foreseeability, proximity, and the just and reasonable requirement. Keane CJ explicitly preferred this structured approach over either the Anns two-stage test or a purely incremental methodology. The just and reasonable requirement was independently applied: judicial review was available to challenge the ultra vires moratorium, the relationship between a statutory body and local businesses was not one of assumption of responsibility, and liability to an indeterminate class would arise if a duty were imposed. Glencar remains the foundational statement of Irish negligence law and is the primary reference point in FE-1 torts courses alongside Ward v McMaster. All subsequent Irish duty of care analysis takes Glencar as its starting point.',
    subjects: ['torts'],
    topics: [
      'negligence',
      'duty of care',
  ...
  },
  {
    ...
    key_quote:
      'The Caparo three-stage test does not provide a formula which can be applied mechanically to determine whether a duty of care exists. In the ordinary run of cases, courts should apply established principles; only in novel situations do the Caparo criteria serve as a guide.',
    full_summary:
  ...
  },
  {
    ...
    jurisdiction: 'England',
    legal_principle:
      'The standard of care in negligence is objective: the defendant must act as a reasonable person of ordinary prudence, not according to their own subjective judgment or limited intelligence. A person who genuinely but unreasonably believed their conduct was safe is nonetheless liable if the reasonable person would have recognised the risk.',
    key_quote:
      "The standard of care is not based on the defendant's own judgment of what is prudent; it is the objective standard of a man of ordinary prudence. A man who acts to the best of his judgment may still be negligent if a reasonable person would have done otherwise.",
    full_summary:
    ...
    is_frequently_tested: true,
    past_paper_appearances: ['Torts FE-1 2016 Q2', 'Torts FE-1 2020 Q2'],
  },
  {
    ...
    is_frequently_tested: true,
    past_paper_appearances: ['Torts FE-1 2015 Q2', 'Torts FE-1 2018 Q2', 'Torts FE-1 2021 Q2'],
  },
  {
  ...
  },
  {
    ...
    is_frequently_tested: true,
    past_paper_appearances: ['Torts FE-1 2016 Q2', 'Torts FE-1 2019 Q2', 'Torts FE-1 2022 Q2'],
  },
  {
  ...
  },
  {
    ...
    is_frequently_tested: true,
    past_paper_appearances: ['Torts FE-1 2018 Q2', 'Torts FE-1 2021 Q3'],
  },
  {
  ...
  },
  {
    ...
    is_frequently_tested: true,
    past_paper_appearances: ['Torts FE-1 2017 Q3', 'Torts FE-1 2020 Q3'],
  },
  {
  ...
  },
  {
    ...
    is_frequently_tested: true,
    past_paper_appearances: ['Torts FE-1 2016 Q4', 'Torts FE-1 2019 Q4', 'Torts FE-1 2022 Q4'],
  },
  {
  ...
  },
  {
    ...
    is_frequently_tested: true,
    past_paper_appearances: ['Torts FE-1 2016 Q3', 'Torts FE-1 2019 Q3', 'Torts FE-1 2022 Q3'],
  },
  {
    ...
    jurisdiction: 'England',
    legal_principle:
      "Under the 'direct consequences' test for remoteness of damage, a defendant who is negligent is liable for all the direct consequences of their negligent act, whether or not those consequences were foreseeable. Foreseeability of the particular type of harm is not required for liability; it is enough that the defendant was negligent and that the damage was a direct consequence of the negligence.",
    key_quote:
      'If the act would or might probably cause damage, the fact that the damage it in fact causes is not the exact kind of damage one would expect is immaterial, so long as the damage is in fact directly traceable to the negligent act.',
    full_summary:
      "Re Polemis and Furness Withy & Co Ltd [1921] 3 KB 560 is an important Court of Appeal decision on remoteness of damage in negligence. Stevedores chartered by the defendant accidentally knocked a plank into the hold of the ship, which caused a spark that ignited petrol vapour, resulting in the destruction of the entire ship by fire. It was foreseeable that the plank might cause some damage if dropped, but the destruction of the ship by fire was not foreseeable. The Court of Appeal held the defendants liable for the full loss. Scrutton LJ applied what became known as the 'direct consequences' test: once the defendant acts negligently, they are liable for all direct consequences of that negligence, even those that are unforeseeable. Re Polemis was overruled by the Privy Council in The Wagon Mound (No. 1) [1961], which substituted the foreseeability test for remoteness. Re Polemis is therefore studied principally as a contrast to The Wagon Mound, and for the historical development of the remoteness doctrine in FE-1 torts.",
    subjects: ['torts'],
    topics: [
      'negligence',
      'remoteness',
  ...
  },
  {
    ...
    is_frequently_tested: true,
    past_paper_appearances: ['Torts FE-1 2015 Q4', 'Torts FE-1 2018 Q4', 'Torts FE-1 2021 Q4'],
  },
  {
  ...
  },
  {
    ...
    is_frequently_tested: true,
    past_paper_appearances: ['Torts FE-1 2017 Q5', 'Torts FE-1 2020 Q5'],
  },
  {
    ...
    is_frequently_tested: true,
    past_paper_appearances: ['Torts FE-1 2017 Q5', 'Torts FE-1 2021 Q5'],
  },
  {
    ...
    is_frequently_tested: true,
    past_paper_appearances: ['Torts FE-1 2016 Q5', 'Torts FE-1 2020 Q5'],
  },
  {
  ...
  },
  {
    ...
    is_frequently_tested: true,
    past_paper_appearances: ['Torts FE-1 2016 Q5', 'Torts FE-1 2019 Q5', 'Torts FE-1 2022 Q5'],
  },
  {
  ...
  },
  {
    ...
    is_frequently_tested: true,
    past_paper_appearances: ['Torts FE-1 2018 Q5', 'Torts FE-1 2021 Q5'],
  },
  {
    ...
    jurisdiction: 'England',
    legal_principle:
      'An employer is liable for psychiatric harm caused by occupational stress only if it was reasonably foreseeable that the particular employee would suffer a breakdown. The employer is generally entitled to take what an employee tells them at face value; if an employee does not communicate distress, the employer will rarely be liable. Where an employer provides a confidential advice service, this will ordinarily discharge the duty of care in the absence of specific signs of psychiatric risk.',
    key_quote:
      'The threshold question is whether this kind of harm to this particular employee was reasonably foreseeable. An employer who provides a confidential counselling service with referral to treatment will commonly not be in breach of duty.',
    full_summary:
      "Sutherland v Hatton [2002] EWCA Civ 76 is the most important English Court of Appeal decision on employer liability for occupational stress. The case involved four conjoined appeals, each concerning an employee who suffered psychiatric harm from work-related stress. Hale LJ delivered a comprehensive judgment setting out practical guidance on the law governing stress at work claims. The key principles established include: (i) the duty of care applies to psychiatric harm just as to physical harm; (ii) the threshold question is foreseeability of psychiatric harm to the particular employee; (iii) employers are entitled to assume employees can withstand normal work pressures unless they have specific notice of vulnerability; (iv) where an employer offers a confidential counselling service, this will often discharge the duty; and (v) the employee must show that the employer's breach caused the psychiatric harm. Sutherland v Hatton is a cornerstone FE-1 torts case on workplace psychiatric injury and the framework it provides is applied in Irish cases including Berber v Dunnes Stores [2009] and McGrath v Trintech.",
    subjects: ['torts'],
    topics: [
      'negligence',
      "employer's liability",
  ...
  },
  {
    ...
    jurisdiction: 'England',
    legal_principle:
      "An employer owes a duty of care to protect employees from psychiatric harm caused by excessive workplace stress. Where an employee has already suffered a stress-related breakdown and the employer is aware of this, the employer is on notice of the employee's particular vulnerability and owes a heightened duty to take steps to prevent a recurrence. Failure to take reasonable protective steps after the first breakdown may render the employer liable for a subsequent psychiatric injury.",
    key_quote:
      "Once it was foreseeable that a second breakdown was likely because of the excessive workload and the plaintiff's known vulnerability after the first breakdown, the defendant was in breach of its duty of care in failing to provide adequate assistance.",
    full_summary:
    ...
    is_frequently_tested: true,
    past_paper_appearances: ['Torts FE-1 2016 Q5', 'Torts FE-1 2019 Q5'],
  },
  {
    ...
    is_frequently_tested: true,
    past_paper_appearances: ['Torts FE-1 2018 Q5', 'Torts FE-1 2021 Q5', 'Torts FE-1 2023 Q5'],
  },
  {
    ...
    jurisdiction: 'Ireland',
    legal_principle:
      'An employer in Ireland owes a duty of care to employees in respect of psychiatric harm caused by workplace stress. The duty requires the employer to take reasonable and appropriate steps to protect employees from foreseeable psychiatric harm arising from their working conditions. Where an employee communicates their distress and the employer fails to take any action, liability may arise.',
    key_quote:
      "The employer's duty of care extends to the psychiatric wellbeing of employees. Where an employer has notice that an employee is suffering from excessive workplace stress and takes no steps to address it, the employer may be liable for any resulting psychiatric harm.",
    full_summary:
      "McGrath v Trintech Technologies Ltd [2004] IEHC 342 is an Irish High Court decision applying the English workplace stress principles (Walker v Northumberland [1995], Sutherland v Hatton [2002]) to Irish law. The plaintiff was an employee of a technology company who suffered a breakdown caused by excessive workload and stress. He had raised his concerns with management but no action was taken to reduce his workload. Clarke J (as he then was) held that the employer had breached its duty of care. The employer had notice of the employee's distress — he had communicated his difficulties to management — and the psychiatric harm was foreseeable. The failure to take any reasonable steps to address the workload constituted a breach. McGrath v Trintech is an important Irish application of the Sutherland v Hatton framework and is studied in FE-1 torts alongside Berber v Dunnes Stores [2009] as part of the Irish law on occupational stress.",
    subjects: ['torts'],
    topics: [
      'negligence',
      "employer's liability",
  ...
  },
  {
    ...
    jurisdiction: 'Ireland',
    legal_principle:
      "The Irish courts, in applying the employer's duty of care in respect of psychiatric harm, follow the general framework that foreseeability of psychiatric harm to the particular employee is the threshold question. Where the employer is placed on notice that an employee is at risk of psychiatric harm due to workplace conditions and fails to take reasonable steps, liability arises. The burden of proof rests on the plaintiff to establish that the risk was foreseeable to the particular employer.",
    key_quote:
      'The threshold question of foreseeability is whether it was reasonably foreseeable that this particular employee would suffer a psychiatric injury. Signs of stress in the employee, communicated to management, are the clearest indication that the threshold is crossed.',
    full_summary:
      "Maher v Jabil Global Services Ltd [2005] IEHC 130 is an Irish High Court decision on employer's liability for occupational stress-induced psychiatric injury. The plaintiff suffered a breakdown attributable to excessive workload and insufficient support in her role at Jabil, a manufacturing company. The court had to apply the Irish and English authorities on workplace psychiatric harm. The High Court applied the Sutherland v Hatton guidance and the emerging Irish approach developed in cases such as McGrath v Trintech. The court held that the plaintiff had communicated her difficulties to her employer and that the risk of psychiatric harm was foreseeable at the time the employer failed to act. Liability was established. Maher v Jabil is cited in FE-1 Irish torts courses alongside McGrath v Trintech and Berber v Dunnes Stores as part of the series of Irish decisions applying and developing the law on workplace psychiatric injury.",
    subjects: ['torts'],
    topics: [
      'negligence',
      "employer's liability",
    ...
    is_frequently_tested: true,
    past_paper_appearances: ['Torts FE-1 2018 Q5'],
  },
  {
    ...
    is_frequently_tested: true,
    past_paper_appearances: ['Torts FE-1 2017 Q5'],
  },
  {
    ...
    is_frequently_tested: true,
    past_paper_appearances: ['Torts FE-1 2019 Q5', 'Torts FE-1 2022 Q5'],
  },
  {
    ...
    is_frequently_tested: true,
    past_paper_appearances: ['Torts FE-1 2017 Q6', 'Torts FE-1 2020 Q6'],
  },
  {
    ...
    is_frequently_tested: true,
    past_paper_appearances: ['Torts FE-1 2016 Q6', 'Torts FE-1 2019 Q6', 'Torts FE-1 2022 Q6'],
  },
  {
  ...
  },
  {
    ...
    is_frequently_tested: true,
    past_paper_appearances: ['Torts FE-1 2018 Q6', 'Torts FE-1 2021 Q6', 'Torts FE-1 2023 Q6'],
  },
  {
    ...
    is_frequently_tested: true,
    past_paper_appearances: ['Torts FE-1 2015 Q6', 'Torts FE-1 2018 Q6'],
  },
  {
  ...
  },
  {
    ...
    is_frequently_tested: true,
    past_paper_appearances: ['Torts FE-1 2018 Q6', 'Torts FE-1 2021 Q6'],
  },
  {
  ...
  },
  {
    ...
    is_frequently_tested: true,
    past_paper_appearances: ['Torts FE-1 2017 Q6', 'Torts FE-1 2020 Q6', 'Torts FE-1 2023 Q6'],
  },
  {
  ...
  },
  {
    ...
    full_summary:
      "A v National Blood Authority [2001] 3 All ER 289 is the leading English decision on the Consumer Protection Act 1987 and product liability for defective blood products. The claimants had been infected with Hepatitis C through contaminated blood transfusions administered through the National Blood Authority. The Authority contended that the blood products were not 'defective' within the Act and that the 'development risks' defence applied because the risk was known but unavoidable with the technology of the time. Burton J held that the blood products were defective: the public was entitled to expect that blood supplied for transfusion would be safe. He distinguished between standard products (where the development risks defence may apply) and non-standard products that deviate from the producer's intended design (where it cannot). Contaminated blood units were non-standard products: each was a product that did not meet the standard the producer intended. A v National Blood Authority is a cornerstone FE-1 torts case on the Consumer Protection Act 1987, the definition of defective products, and the development risks defence.",
    subjects: ['torts'],
    topics: [
      'product liability',
    ...
    is_frequently_tested: true,
    past_paper_appearances: ['Torts FE-1 2016 Q7', 'Torts FE-1 2019 Q7', 'Torts FE-1 2022 Q7'],
  },
  {
    ...
    jurisdiction: 'England',
    legal_principle:
      "In assessing whether a medical device is 'defective' under the Consumer Protection Act 1987, the court must have regard to what persons generally are entitled to expect of the product. For medical implants, the expected standard is high, but some failure rate is to be expected. A product is not defective merely because it fails in a particular case if it performs to the standard generally expected of such products and the failure is within the range of acceptable performance.",
    key_quote:
      'The question of what safety the public is entitled to expect from a medical device must be assessed by reference to the product as a class. A low but known failure rate does not of itself establish that a product is defective; all the circumstances must be considered.',
    full_summary:
    ...
    is_frequently_tested: true,
    past_paper_appearances: ['Torts FE-1 2017 Q7', 'Torts FE-1 2021 Q7'],
  },
  {
    ...
    is_frequently_tested: true,
    past_paper_appearances: ['Torts FE-1 2017 Q7', 'Torts FE-1 2021 Q7', 'Torts FE-1 2023 Q7'],
  },
  {
  ...
  },
  {
    ...
    jurisdiction: 'England',
    legal_principle:
      'Under the Consumer Protection Act 1987, the development risks defence will not be available where the state of scientific knowledge, viewed objectively and as a whole, was such that the defect could have been discovered. The defence requires the producer to show that no producer of products of the same description could have discovered the defect at the time; it is not satisfied merely by showing that the specific producer was unaware of the defect.',
    key_quote:
      'The development risks defence requires an objective assessment of the state of scientific knowledge at the time. It is not enough that the particular producer was unaware of the defect; the question is whether any producer could have discovered it.',
    full_summary:
    ...
    is_frequently_tested: true,
    past_paper_appearances: ['Torts FE-1 2018 Q7', 'Torts FE-1 2021 Q7'],
  },
  {
    ...
    is_frequently_tested: true,
    past_paper_appearances: ['Torts FE-1 2018 Q7'],
  },
  {
    ...
    jurisdiction: 'Ireland',
    legal_principle:
      "The tort of passing off protects a trader's goodwill by preventing a rival from misrepresenting their goods as those of the plaintiff or as being associated with the plaintiff. The three elements of passing off are: (i) goodwill in the plaintiff's get-up or mark; (ii) a misrepresentation by the defendant that is likely to deceive the public; and (iii) damage to the plaintiff's goodwill as a result. Note: This case also addresses packaging/product similarities.",
    key_quote:
      "The essential elements of passing off require proof of goodwill, misrepresentation, and damage. The misrepresentation must be one likely to deceive members of the public into thinking that the defendant's product is that of the plaintiff.",
    full_summary:
    ...
    is_frequently_tested: true,
    past_paper_appearances: ['Torts FE-1 2017 Q8', 'Torts FE-1 2021 Q8'],
  },
  {
    ...
    jurisdiction: 'Ireland',
    legal_principle:
      "A private nuisance claim requires proof of an unreasonable interference with the plaintiff's use and enjoyment of land. The defendant need not intend to cause nuisance; it is sufficient that the interference is unreasonable. A local authority responsible for flooding caused by inadequate drainage infrastructure may be liable in private nuisance to landowners whose property is damaged by the resulting flood.",
    key_quote:
      "Private nuisance consists of an unreasonable interference with the plaintiff's use and enjoyment of land. It is not necessary to prove intent; the test is whether the interference is unreasonable in all the circumstances.",
    full_summary:
      "Superquinn Ltd v Bray Urban District Council [1998] 3 IR 542 is an Irish High Court decision on the tort of private nuisance in the context of flooding caused by defective drainage infrastructure. Superquinn's premises were flooded on a number of occasions due to the inadequacy of drains under the Council's management. Superquinn claimed in private nuisance, public nuisance, and negligence. The High Court held that the Council was liable in private nuisance: the repeated flooding constituted an unreasonable interference with Superquinn's use and enjoyment of its land. The council had control over the drainage system and the flooding was a foreseeable consequence of its failure to maintain it adequately. The court found that the council had adopted the nuisance by its failure to remedy the problem within a reasonable time. The decision is important in FE-1 torts courses on private nuisance, public authority liability, and the liability of an occupier for the adoption of pre-existing nuisances.",
    subjects: ['torts'],
    topics: [
      'nuisance',
      'private nuisance',
    ...
    is_frequently_tested: true,
    past_paper_appearances: ['Torts FE-1 2016 Q8', 'Torts FE-1 2020 Q8'],
  },
  {
    ...
    jurisdiction: 'England',
    legal_principle:
      'A person who for their own purposes brings onto their land and collects and keeps there anything likely to do mischief if it escapes must keep it at their peril; if they do not do so, they are prima facie answerable for all the damage which is the natural consequence of its escape. This is the rule of strict liability for non-natural use of land.',
    key_quote:
  ...
  },
  {
    ...
    is_frequently_tested: true,
    past_paper_appearances: ['Torts FE-1 2015 Q8', 'Torts FE-1 2018 Q8', 'Torts FE-1 2021 Q8'],
  },
  {
  ...
  },
  {
    ...
    is_frequently_tested: true,
    past_paper_appearances: ['Torts FE-1 2017 Q8', 'Torts FE-1 2020 Q8'],
  },
  {
  ...
  },
  {
    ...
    jurisdiction: 'Ireland',
    legal_principle:
      'In an action for private nuisance, a tenant or licensee of land who suffers unreasonable interference with their use and enjoyment of the land has locus standi to bring a nuisance claim, even if they do not hold the freehold. The defendant need not own the land from which the nuisance emanates; it is sufficient that they have control over the activity or condition causing the interference.',
    key_quote:
      'A person who has a sufficient interest in the use and enjoyment of land has locus standi to bring an action in private nuisance. The interest need not be freehold ownership.',
    full_summary:
    ...
    subjects: ['torts'],
    topics: ['nuisance', 'private nuisance', 'locus standi', 'Ireland', 'tenant', 'interference'],
    is_frequently_tested: false,
    past_paper_appearances: [],
  },
  {
    ...
    jurisdiction: 'Ireland',
    legal_principle:
      "A statutory body exercising its functions in relation to land owes a duty of care to persons foreseeably at risk from the manner in which those functions are exercised. The Occupiers' Liability Act does not displace the common law of negligence where the injury arises from the manner in which the defendant manages its land as a commercial enterprise rather than from the state of the land per se.",
    key_quote:
      'The fact that the defendant manages State forestry land does not insulate it from the duty of care applicable to persons foreseeably affected by its operations. The ordinary principles of negligence apply.',
    full_summary:
    ...
    is_frequently_tested: true,
    past_paper_appearances: ['Torts FE-1 2016 Q5'],
  },
  {
    ...
    key_quote:
      'The act was done by the driver in the course of his employment, even though it was done contrary to an express prohibition. The employers are liable because the servant was doing an act which he was employed to do — namely, drive an omnibus — though he did it in a wrongful way.',
    full_summary:
    ...
    is_frequently_tested: true,
    past_paper_appearances: ['Torts FE-1 2015 Q9', 'Torts FE-1 2018 Q9'],
  },
  {
  ...
  },
  {
    ...
    jurisdiction: 'England',
    legal_principle:
      "An employer is vicariously liable for the deliberate criminal acts of an employee where those acts are so closely connected with the employment that it would be fair and just to hold the employer vicariously liable. The 'close connection' test asks whether the employee's wrongdoing is so closely connected with the duties they were engaged to perform that it would be fair and just to hold the employer vicariously liable, even for deliberate torts.",
    key_quote:
      "The sufficiency of the connection between the employment and the wrongdoing is the touchstone of liability. If the employee's wrong is so closely connected with acts he was authorised to do that it would be fair and just to hold the employer vicariously liable, then the employer will be liable.",
    full_summary:
    ...
    is_frequently_tested: true,
    past_paper_appearances: ['Torts FE-1 2015 Q9', 'Torts FE-1 2018 Q9', 'Torts FE-1 2021 Q9'],
  },
  {
    ...
    jurisdiction: 'England',
    legal_principle:
      "A partnership (or employer) may be vicariously liable under the Partnership Act 1890 for the wrongful acts of a partner committed in the ordinary course of the firm's business. The 'close connection' test from Lister applies: the question is whether the acts were so closely connected with acts which the partner was authorised to do that it would be fair and just to hold the firm vicariously liable.",
    key_quote:
      "The 'close connection' test is the right test: whether the partner's wrongful conduct was so closely connected with acts he was authorised to do that, for the purpose of liability of innocent co-partners, it may fairly and properly be regarded as done by him while acting in the ordinary course of the firm's business.",
    full_summary:
      "Dubai Aluminium Co Ltd v Salaam [2002] UKHL 48 is a significant House of Lords decision applying the close connection test to the vicarious liability of a partnership for a partner's dishonest acts. A partner in a firm of solicitors assisted in a massive fraud against Dubai Aluminium by drafting sham agreements. The firm was sued vicariously. The House of Lords held the firm vicariously liable. Lord Nicholls applied the close connection test from Lister and held that the dishonest acts were so closely connected with the partner's authorised act (drafting legal agreements) that it was fair and just to hold the firm liable. The acts were performed in the ordinary course of carrying out professional work for which the firm was retained. Dubai Aluminium is studied in FE-1 torts courses on vicarious liability, in particular the application of the close connection test to professional firms and partnership liability.",
    subjects: ['torts'],
    topics: [
      'vicarious liability',
      'close connection test',
    ...
    is_frequently_tested: true,
    past_paper_appearances: ['Torts FE-1 2016 Q9', 'Torts FE-1 2019 Q9'],
  },
  {
    ...
    jurisdiction: 'England',
    legal_principle:
      'An employer can be vicariously liable under the Protection from Harassment Act 1997 for harassment committed by an employee in the course of employment. The general principle of vicarious liability extends to statutory torts as well as common law torts, subject to any contrary provision in the statute.',
    key_quote:
      'The principle of vicarious liability applies to statutory torts, including harassment under the Protection from Harassment Act 1997, unless the statute expressly or by necessary implication excludes it. An employer may therefore be vicariously liable for workplace harassment by an employee.',
    full_summary:
      "Majrowski v Guy's and St Thomas's NHS Trust [2006] UKHL 34 arose when Mr Majrowski brought a claim against his employer NHS Trust for harassment by his manager under the Protection from Harassment Act 1997. The question was whether an employer could be vicariously liable for harassment committed by an employee under the 1997 Act. The House of Lords held that vicarious liability was not confined to common law torts but extended to statutory torts unless the statute excluded it. The 1997 Act contained no such exclusion. Accordingly, the NHS Trust could be vicariously liable for its manager's harassment of the claimant, provided the harassment occurred in the course of employment. Majrowski is studied in FE-1 torts on the extension of vicarious liability to statutory torts and on employer liability for workplace harassment.",
    subjects: ['torts'],
    topics: [
      'vicarious liability',
      'harassment',
    ...
    is_frequently_tested: true,
    past_paper_appearances: ['Torts FE-1 2017 Q9', 'Torts FE-1 2020 Q9'],
  },
  {
    ...
    is_frequently_tested: true,
    past_paper_appearances: ['Torts FE-1 2018 Q9', 'Torts FE-1 2021 Q9'],
  },
  {
  ...
  },
  {
    ...
    is_frequently_tested: true,
    past_paper_appearances: ['Torts FE-1 2018 Q9', 'Torts FE-1 2021 Q9', 'Torts FE-1 2023 Q9'],
  },
  {
  ...
  },
  {
    ...
    is_frequently_tested: true,
    past_paper_appearances: ['Torts FE-1 2016 Q10', 'Torts FE-1 2019 Q10', 'Torts FE-1 2022 Q10'],
  },
  {
  ...
  },
  {
    ...
    jurisdiction: 'UK',
    legal_principle:
      "The UKSC held that the congregation was not vicariously liable for rape committed by an elder of the Jehovah's Witnesses, as the elder was a volunteer performing religious duties and the relationship lacked sufficient features of an employment-like relationship. The case provides important limits on the expansion of vicarious liability to voluntary religious roles.",
    key_quote:
      'The elder carried out his religious activities as a volunteer. The relationship between the congregation and the elder did not have the features of an employment or quasi-employment relationship necessary to impose vicarious liability.',
    full_summary:
      "BXB was raped by Mark Sewell, an elder in the Barry Congregation of Jehovah's Witnesses. She brought proceedings against the congregation's trustees, arguing vicarious liability. The UKSC unanimously held there was no vicarious liability. Applying the two-stage test, the court found that the first stage — a relationship akin to employment — was not satisfied. Elders within the Jehovah's Witnesses are unpaid volunteers; they are not directed, supervised, or remunerated in any way analogous to employees. The court distinguished the Christian Brothers case, where the Brothers were directed in their work by their superiors and integrated into the institutional hierarchy in a manner bearing close resemblance to employment. The UKSC emphasised that not every relationship between a religious organisation and its ministers or volunteers will generate vicarious liability: the relationship must be sufficiently close to employment in its functional characteristics. The decision provides a significant clarification of the outer limits of vicarious liability and confirms that voluntary religious service does not, without more, create the necessary relationship. It is the most recent major UKSC statement on the doctrine.",
    subjects: ['torts'],
    topics: [
      'vicarious liability',
  ...
  },
  {
    ...
    jurisdiction: 'IE',
    legal_principle:
      'The Supreme Court held that an employer owes a non-delegable duty to provide a safe system of work, safe premises, and competent fellow employees. The court confirmed that this duty cannot be discharged by delegating safety responsibilities to independent contractors. A railway employee injured due to defective equipment was entitled to succeed.',
    key_quote:
      'The duty of an employer to take reasonable care for the safety of his employees is a personal and non-delegable duty which cannot be discharged by entrusting its performance to an independent contractor.',
    full_summary:
  ...
  },
  {
    ...
    jurisdiction: 'UK',
    legal_principle:
      'The Court of Appeal held that a sports governing body can owe a duty of care to participants where it has assumed responsibility for their safety. The British Boxing Board of Control was liable for inadequate ringside medical provision that led to Michael Watson suffering severe brain damage after a title fight.',
    key_quote:
      'The Board had assumed responsibility for determining the medical arrangements for professional boxing matches and it was foreseeable that if those arrangements were inadequate, a boxer could suffer serious injury. A duty of care arose.',
    full_summary:
  ...
  },
  {
    ...
    jurisdiction: 'IE',
    legal_principle:
      'The Supreme Court considered the standard of care owed by a retailer to customers on its premises. The court held that a supermarket must take reasonable steps to keep its floors safe and that a failure to implement an adequate floor inspection system could ground liability in negligence.',
    key_quote:
      'A retailer who invites the public onto its premises must take all reasonable steps to ensure that those premises are safe, including the implementation of an adequate system of inspection and cleaning.',
    full_summary:
  ...
  },
  {
    ...
    jurisdiction: 'IE',
    legal_principle:
      'The High Court held that a bus operator owes a duty of care to passengers and must ensure the bus does not move until passengers are safely seated or have alighted. A passenger injured when the bus moved off prematurely was entitled to recover damages.',
    key_quote:
      'A bus operator is under a duty to take reasonable care for the safety of its passengers, which includes ensuring the vehicle does not move while a passenger is in the process of boarding or alighting.',
    full_summary:
    ...
    subjects: ['torts'],
    topics: ['public transport', 'passenger injury', 'negligence', 'bus operator', 'duty of care'],
    is_frequently_tested: false,
    past_paper_appearances: [],
  },
  {
    ...
    jurisdiction: 'IE',
    legal_principle:
      'The High Court examined the liability of Dublin Bus to a passenger injured in an emergency stop. The court applied the standard of the reasonable bus driver and assessed contributory negligence on the part of a standing passenger.',
    key_quote:
      'The standard of care applicable to a bus driver is that of a reasonably skilled and careful professional driver, and passengers who choose to stand on a moving bus accept some degree of risk.',
    full_summary:
  ...
  },
  {
    ...
    jurisdiction: 'IE',
    legal_principle:
      'The High Court considered the duty of care owed to passengers alighting from a Dublin Bus vehicle. The court found liability where a passenger was injured by the bus door closing prematurely, establishing that bus drivers must take care not to close doors until it is safe to do so.',
    key_quote:
      'A bus driver who closes the doors of the vehicle before a passenger has fully alighted breaches the duty of care owed to that passenger, and the operator is liable for any resulting injury.',
    full_summary:
  ...
  },
  {
    ...
    jurisdiction: 'IE',
    legal_principle:
      "The Supreme Court examined the duty of care owed by a rail operator to passengers. The court upheld a finding of contributory negligence against a passenger who placed himself in a dangerous position, while confirming the operator's duty to maintain safe conditions on trains.",
    key_quote:
      'Irish Rail owes a duty of care to passengers to maintain safe conditions on its trains, but a passenger who voluntarily places himself in a position of obvious danger may be found contributorily negligent.',
    full_summary:
  ...
  },
  {
    ...
    jurisdiction: 'IE',
    legal_principle:
      "The Supreme Court considered the employer's liability to an employee injured while working on the railway. The court confirmed the non-delegable nature of the employer's duty to provide a safe system of work and proper training, while assessing the degree of contributory negligence attributable to the experienced worker.",
    key_quote:
      "The employer's duty to provide a safe system of work is non-delegable and extends to the provision of adequate training and supervision, but an experienced employee who fails to follow established safety procedures may be found contributorily negligent.",
    full_summary:
  ...
  },
  {
    ...
    jurisdiction: 'IE',
    legal_principle:
      'The Supreme Court considered an appeal on the quantum of damages awarded to a bus passenger who suffered physical and psychiatric injury following a collision. The court addressed the proper approach to general damages for pain and suffering and the assessment of future loss, providing guidance on damages methodology in personal injury cases.',
    key_quote:
      "In assessing general damages for pain and suffering, the court must take account of the totality of the plaintiff's injury, including its psychiatric component, and must award a sum that is fair and reasonable to both parties.",
    full_summary:
  ...
  },
  {
    ...
    jurisdiction: 'IE',
    legal_principle:
      "The Court of Appeal considered the liability of a main contractor for injuries to a sub-contractor's employee on a construction site. The court held that a main contractor owes a duty to take reasonable care for the safety of all workers on site under its control, even those employed by sub-contractors, particularly where the main contractor has overall site responsibility.",
    key_quote:
      'A main contractor who has overall responsibility for safety on a construction site owes a duty of care to all workers on that site, including those employed by sub-contractors, insofar as the main contractor has control over the conditions giving rise to the risk.',
    full_summary:
  ...
  },
  {
    ...
    jurisdiction: 'IE',
    legal_principle:
      "The High Court found Bus Eireann liable for injuries sustained by a passenger in a road traffic accident caused by the bus driver's negligence. The court applied standard negligence principles and considered the extent to which the plaintiff's damages should be reduced for contributory negligence.",
    key_quote:
      'A bus operator is liable in negligence for the acts of its driver in causing a road traffic accident, and the damages awarded to an injured passenger may be reduced where that passenger was contributorily negligent.',
    full_summary:
  ...
  },
  {
    ...
    jurisdiction: 'IE',
    legal_principle:
      "The Supreme Court upheld an IR£300,000 jury award to the Labour Party leader for defamatory articles in the Sunday Independent falsely linking him to anti-Semitism and Communist atrocities. The court held that the award was not disproportionate given the gravity of the libel and the publication's wide circulation, establishing an important precedent on jury-assessed defamation damages in Ireland.",
    key_quote:
      'The jury was entitled to take into account the gravity of the libel, its wide circulation, and the standing of the plaintiff in awarding the damages complained of.',
    full_summary:
    ...
    subjects: ['torts'],
    topics: ['defamation', 'jury damages', 'proportionality', 'newspaper'],
    is_frequently_tested: true,
    past_paper_appearances: [],
  },
  {
  ...
  },
  {
    ...
    jurisdiction: 'IE',
    legal_principle:
      'The Supreme Court considered the defence of truth (previously justification) under the Defamation Act 2009. The court held that a defendant relying on truth must establish that the statement was substantially true. McDonagh provides important guidance on the modern Irish approach to the truth defence and its interaction with jury directions.',
    key_quote:
      'The defence of truth under the Defamation Act 2009 requires the defendant to prove that the imputation conveyed by the statement is substantially true.',
    full_summary:
    ...
    subjects: ['torts'],
    topics: ['defamation', 'truth defence', 'Defamation Act 2009', 'justification'],
    is_frequently_tested: true,
    past_paper_appearances: [],
  },
  {
  ...
  },
  {
    ...
    jurisdiction: 'UK',
    legal_principle:
      "The Court of Appeal held that defamation proceedings may constitute an abuse of process where the publication in question is so limited that it could not have caused real and substantial tort to the claimant. The case established the 'Jameel abuse' doctrine: where the game is not worth the candle, the court may strike out the claim.",
    key_quote:
      'If the claimant has suffered no real damage, or the damage is so trivial that it would be disproportionate to allow the action to proceed, the court may strike it out as an abuse of process.',
    full_summary:
    ...
    subjects: ['torts'],
    topics: ['defamation', 'abuse of process', 'publication', 'minimal publication'],
    is_frequently_tested: true,
    past_paper_appearances: [],
  },
  {
  ...
  },
  {
    ...
    jurisdiction: 'UK',
    legal_principle:
      "The House of Lords broadly defined goodwill as the benefit and advantage of the good name, reputation, and connection of a business — 'the attractive force which brings in custom.' This definition remains the foundational statement on the nature of goodwill in passing off and intellectual property law.",
    key_quote:
    ...
    subjects: ['torts'],
    topics: ['passing off', 'goodwill', 'reputation', 'trade name'],
    is_frequently_tested: true,
    past_paper_appearances: [],
  },
  {
  ...
  },
  {
    ...
    jurisdiction: 'IE',
    legal_principle:
      'The Supreme Court examined the circumstances in which a statutory body may be liable in negligence for acts or omissions in the exercise of its statutory functions. The court applied the Glencar framework and considered whether an assumption of responsibility by a regulator could give rise to a duty of care in the economic loss context.',
    key_quote:
      'A statutory body does not automatically owe a duty of care in negligence to persons affected by the exercise of its statutory functions; the existence of a duty depends on the application of the Glencar framework and the particular circumstances of the relationship between the parties.',
    full_summary:
    ...
    subjects: ['torts'],
    topics: ['statutory duty', 'public authority', 'economic loss', 'employer liability'],
    is_frequently_tested: true,
    past_paper_appearances: [],
  },
  {
  ...
  },
  {
    ...
    jurisdiction: 'IE',
    legal_principle:
      'The High Court applied the Dunne v National Maternity Hospital principles to a claim against a private hospital for alleged nursing negligence. The court reiterated that the standard of care for medical and nursing staff is that of the reasonably competent practitioner in the relevant specialty, and that departure from general and approved practice must be established by expert evidence.',
    key_quote:
      'The standard of care applicable to nursing staff is that of the reasonably competent practitioner in the relevant specialty; departure from general and approved practice must be demonstrated by expert evidence.',
    full_summary:
    ...
    subjects: ['torts'],
    topics: ['medical negligence', 'hospital', 'standard of care', 'nursing'],
    is_frequently_tested: false,
    past_paper_appearances: [],
  },
  {
  ...
  },
  {
    ...
    jurisdiction: 'IE',
    legal_principle:
      "The High Court considered the duty of care owed by the Office of Public Works as occupier of a heritage site to a visitor who was injured on the premises. The court applied the Occupiers' Liability Act 1995 and held that, as a visitor, the plaintiff was owed a duty to take reasonable care, which included appropriate warnings about hazards.",
    key_quote:
      "As occupier of a heritage site open to visitors, the OPW owes a duty under the Occupiers' Liability Act 1995 to take reasonable care for the safety of those admitted, including providing adequate warnings of hazards that may not be obvious to the ordinary visitor.",
    full_summary:
    ...
    subjects: ['torts'],
    topics: ['occupiers liability', 'public authority', 'heritage site', 'visitor injury'],
    is_frequently_tested: false,
    past_paper_appearances: [],
  },
  {
  ...
  },
  {
    ...
    jurisdiction: 'IE',
    legal_principle:
      "The Supreme Court held Bus Éireann liable for injuries sustained by a passenger who fell while alighting from a bus. The court confirmed the high duty of care owed by common carriers to passengers and considered the apportionment of contributory negligence where the passenger's own conduct contributed to the fall.",
    key_quote:
      'A common carrier owes a high duty of care to its passengers; where a passenger is injured while alighting from a bus, the carrier must show that it took all reasonable steps to ensure the safety of the disembarkation process.',
    full_summary:
    ...
    subjects: ['torts'],
    topics: ['public transport', 'passenger injury', 'duty of care', 'contributory negligence'],
    is_frequently_tested: false,
    past_paper_appearances: [],
  },
  {
  ...
  },
  {
    ...
    jurisdiction: 'IE',
    legal_principle:
      'The High Court considered a claim arising from a horse-riding accident. The court examined the duty of care owed by a horse owner to a guest rider and considered the defences of volenti non fit injuria and contributory negligence in the context of inherently risky sporting activity.',
    key_quote:
      'A horse owner who invites another to ride a horse known to have unpredictable tendencies owes a duty of care to warn the rider of those characteristics; the defence of volenti requires a voluntary and informed agreement to assume the risk in question.',
    full_summary:
    ...
    subjects: ['torts'],
    topics: ['negligence', 'equine', 'horse riding', 'duty of care', 'volenti'],
    is_frequently_tested: false,
    past_paper_appearances: [],
  },
  {
  ...
  },
  {
    ...
    jurisdiction: 'IE',
    legal_principle:
      'The Supreme Court held a motorist liable for injuring a cyclist at dusk. The court emphasised that drivers must adjust their speed and attention to prevailing light and visibility conditions, and that a failure to spot a cyclist riding without lights does not necessarily absolve a driver of negligence if the cyclist was otherwise visible.',
    key_quote:
      'A motorist must adapt their speed and attentiveness to prevailing conditions of light and visibility; the mere fact that a cyclist is riding without lights does not automatically absolve a driver who ought, in the exercise of reasonable care, to have seen and avoided the cyclist.',
    full_summary:
    ...
    subjects: ['torts'],
    topics: ['negligence', 'road accident', 'cyclist', 'visibility', 'dusk'],
    is_frequently_tested: false,
    past_paper_appearances: [],
  },
  {
  ...
  },
  {
    ...
    jurisdiction: 'UK',
    legal_principle:
      'The House of Lords held that a breach of statutory duty does not automatically give rise to a private law action in tort unless the statute was intended to benefit a particular class of persons or the breach conferred a right to sue on such persons. Where a statute is designed to protect the public generally, breach does not give rise to a private cause of action in tort. The case also addressed the outer limits of the unlawful means limb of economic tort liability.',
    key_quote:
      'To establish a private law right of action for breach of statutory duty it must appear that the particular statute was intended to confer on members of a specific class a right to sue for breach, or that the breach conferred a benefit on a class of which the plaintiff is a member.',
    full_summary:
  ...
  },
  {
    ...
    jurisdiction: 'IE',
    legal_principle:
      "The Supreme Court held that the ESB owed a duty of care to a child trespasser who was electrocuted while climbing an electricity pylon on the defendant's land. The court applied the allurement doctrine, holding that where a dangerous structure on land is likely to attract child trespassers, the occupier owes a duty to take reasonable precautions against the foreseeable risk of injury. McNamara confirmed and extended the principles from O'Hanlon v ESB to electricity transmission infrastructure.",
    key_quote:
      'Where a structure on land constitutes an allurement to children and is inherently dangerous, the occupier owes a duty of care to child trespassers to guard against the foreseeable risk of injury, notwithstanding that the children are trespassers.',
    full_summary:
  ...
  },
  {
    ...
    jurisdiction: 'IE',
    legal_principle:
      "The Court of Appeal considered the duty of care owed by an occupier of a construction or mining site to a person who entered the site for a business purpose. The court applied the Occupiers' Liability Act 1995 and examined whether the plaintiff was a visitor within the meaning of the Act and whether the standard of care had been discharged, having regard to the nature of the premises and the purposes of the visit.",
    key_quote:
      'An occupier of a commercial or industrial site who invites a person onto the premises for a business purpose owes that visitor a duty to take reasonable care having regard to all the circumstances, including the inherent dangers of the type of premises involved.',
    full_summary:
  ...
  },
  {
    ...
    jurisdiction: 'IE',
    legal_principle:
      'The High Court considered claims arising from the supply of pyrite-contaminated hardcore used in building foundations, which caused serious structural damage to houses. The court examined the liability of the quarry operator as supplier under both the Sale of Goods Acts and the common law tort of negligence, addressing questions of latent defect, the time when damage manifests, and the applicable limitation periods.',
    key_quote:
      'A supplier of building materials who places defective products into the stream of commerce owes a duty of care to foreseeable end users and may be liable in negligence for consequential physical damage to property caused by a latent defect in those materials, with the limitation period running from the date the damage becomes manifest or discoverable.',
    full_summary:
      "James Elliott Construction Ltd v Irish Asphalt Ltd [2011] IEHC 269 arose from the widespread use of pyrite-contaminated hardcore quarried and supplied by Irish Asphalt Ltd in the foundations of newly built houses. Pyrite is a mineral that, when exposed to moisture and air, undergoes a chemical reaction causing swelling and heave, resulting in serious structural damage to the buildings above. The High Court was required to consider the legal basis of the claims brought by the building contractor against the quarry operator as supplier of the defective material. The court examined liability under the Sale of Goods Act 1893 and the Sale of Goods and Supply of Services Act 1980, particularly the implied terms as to merchantable quality and fitness for purpose. The court also considered the parallel claim in the tort of negligence, examining whether the defendant, as manufacturer and supplier, owed a duty of care to foreseeable users of the material. The case raised important issues concerning latent defects, since the contamination was not discoverable at the time of supply or construction. The court addressed the question of when damage 'occurred' for limitation purposes, concluding that time runs from when the damage is manifest or reasonably discoverable, not from the date of supply. The decision became a central authority in the Irish pyrite litigation, which affected thousands of homes and gave rise to significant regulatory reform.",
    subjects: ['torts'],
    topics: ['product liability', 'defective materials', 'pyrite', 'construction', 'latent damage'],
    is_frequently_tested: true,
    past_paper_appearances: [],
  },
  {
  ...
  },
  {
    ...
    jurisdiction: 'IE',
    legal_principle:
      'The High Court considered an application for an injunction against the Irish Farmers Association arising from a campaign targeting Lidl stores. The court examined the economic torts of unlawful interference with business, inducing breach of contract, and conspiracy, applying the Campus Oil principles for interlocutory injunctions in the context of trade disputes and economic torts.',
    key_quote:
  ...
  },
  {
    ...
    subjects: ['torts'],
    topics: ['negligence', 'occupiers liability', 'escalator', 'airport', 'duty of care'],
    is_frequently_tested: false,
    past_paper_appearances: [],
  },
  {
  ...
  },
  {
    ...
    subjects: ['torts'],
    topics: ['occupiers liability', 'trespasser', 'reckless disregard', 'CCTV', 'gate'],
    is_frequently_tested: false,
    past_paper_appearances: [],
  },
  {
  ...
  },
  {
    ...
    jurisdiction: 'IE',
    legal_principle:
      "The High Court dismissed an employer liability claim by a stable hand who alleged back injury while emptying a wheelbarrow, applying the principle that an employer is not the insurer of an employee against everyday mishaps occurring during ordinary work tasks. The court confirmed that liability requires proof that the employer's systems or equipment were unsafe, not merely that an injury occurred in the course of ordinary work. The case follows the approach of the Court of Appeal in Nemeth v Topaz Energy Group [2021] IECA 252.",
    key_quote:
      "An employer is not an insurer of its employees against every mishap that occurs in the course of their work; liability requires proof that the employer's system of work or equipment was unsafe, not simply that an injury occurred while the employee was working.",
    full_summary:
  ...
  },
  {
    ...
    jurisdiction: 'IE',
    legal_principle:
      "The High Court refused to admit expert evidence in support of the 'fair and reasonable publication on a matter of public interest' defence under s.26 of the Defamation Act 2009 where the proposed evidence related to matters of public knowledge. The court held that where a matter is already in the public domain and is within the knowledge of the ordinary juror, expert evidence is neither necessary nor admissible to establish it.",
    key_quote:
      'Expert evidence is not admissible in defamation proceedings to establish facts that are already within the public domain and within the knowledge of ordinary reasonable jurors; s.26 of the Defamation Act 2009 does not create a basis for admitting such evidence.',
    full_summary:
  ...
  },
  {
    ...
    jurisdiction: 'IE',
    legal_principle:
      'The High Court confirmed that a plaintiff with a significantly blemished pre-existing reputation may be unable to recover in defamation in respect of words that are consistent with that pre-existing reputation, as such words do not lower the plaintiff in the estimation of right-thinking members of society beyond the level already established. The judgment applies the principle that a plaintiff can only recover for damage to such reputation as they actually possess.',
    key_quote:
      "A person's pre-existing reputation must be taken into account in assessing whether allegedly defamatory words cause actionable damage; words that are no worse than or merely consistent with a plaintiff's established bad reputation may not give rise to liability.",
    full_summary:
  ...
  },
  {
    ...
    jurisdiction: 'IE',
    legal_principle:
      'The High Court applied the Higgins v Irish Aviation Authority damages guidelines to a corporate defamation claim in a default judgment, confirming that the structured approach to defamation damages introduced by Higgins applies equally to corporate as to individual plaintiffs. The case illustrates the practical application of the Higgins framework in circumstances where no defence is entered.',
    key_quote:
      'The Higgins v Irish Aviation Authority framework for assessing defamation damages applies to claims by corporate plaintiffs as well as individuals; the court will assess the gravity of the publication and the damage to reputation within the structured Higgins bands even in default proceedings.',
    full_summary:
...
const extractUniqueJurisdictions = (cases: typeof b): string[] => {
  return [...new Set(cases.map((c) => c.jurisdiction))];
};

console.log(extractUniqueJurisdictions(b));
...
// contract_missing_all

// ['England & Wales', 'USA', 'Northern Ireland', 'Singapore', 'Ireland'];
...
// torts all 
// ['England', 'UK', 'Scotland', 'Ireland', 'Canada', 'IE'];